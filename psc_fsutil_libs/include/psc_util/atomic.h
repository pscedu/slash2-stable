...
#define psc_atomic64_add(v, i)			psc_atomic64_add_return((i), (v))
#define psc_atomic64_sub(v, i)			psc_atomic64_sub_return((i), (v))
...
#define psc_atomic32_cmpxchg(v, old, new)	((int)cmpxchg(&((v)->value), (old), (new)))
#define psc_atomic32_xchg(v, new)		(xchg(&((v)->value), (new)))
#define psc_atomic64_cmpxchg(v, old, new)	((int)cmpxchg(&((v)->value), (old), (new)))
...
static __inline int
psc_atomic32_set_mask(psc_atomic32_t *v, unsigned int mask)
{
	uint32_t old, new;
	CMPXCHG_BUGCHECK_DECL
...
static __inline int
atomic_clear_mask(atomic_t *v, uint32_t mask)
{
	uint32_t old, new;
	CMPXCHG_BUGCHECK_DECL
...
psc_atomic64_set_mask(psc_atomic64_t *v, uint64_t mask)
{
	uint64_t new, old;
	CMPXCHG_BUGCHECK_DECL
 ...
 */
static __inline int
psc_atomic64_sub_and_test(psc_atomic64_t *v, int64_t i)
{
	unsigned char c;
...
static __inline int
psc_atomic32_add_negative(psc_atomic32_t *v, int i)
{
	unsigned char c;
 ...
 */
static __inline int
psc_atomic64_add_negative(psc_atomic64_t *v, int64_t i)
{
	unsigned char c;
